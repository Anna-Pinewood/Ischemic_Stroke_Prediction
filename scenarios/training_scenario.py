...
# nohup poetry run python scenarios/training_scenario.py  /home/martinumer/IschemicData/train/ --gpu true --version-name "exp_add_fc_1024_remove" --logging-level 20 --learning-rate 3.9810717055349735e-05 &
